...
use crypto_hft::orderbook::{OrderBook, OrderBookDelta, OrderBookSnapshot};
...
fn create_large_snapshot(levels: usize) -> OrderBookSnapshot {
    ...
    OrderBookSnapshot::new("BTCUSDT".to_string(), "binance".to_string(), bids, asks, 123456789)
}
...
fn create_delta_updates(count: usize) -> Vec<OrderBookDelta> {
    ...
    for i in 0..count {
        ...
        deltas.push(OrderBookDelta::new(
            "BTCUSDT".to_string(),
            "binance".to_string(),
            vec![crypto_hft::orderbook::types::OrderBookLevel::new(
                create_price(&bid_price_str),
